/**
 * ARQUIVO MODELO PARA AULA: admin.js
 * OBJETIVO: Preencher as lacunas do CRUD consumindo uma API autenticada!
 */
...
const API_BASE_URL = 'https://charada-drab.vercel.app'; 
...
loginForm.addEventListener('submit', async (e) => {
    ...
    console.log("Tentando logar com:", { usuario, password });
    ...
    try {
        ...
        if (resposta.ok) {
            ...
            // Como guardamos essa credencial (tokenAtual) de forma definitiva no navegador?
